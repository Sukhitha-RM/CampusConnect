...
function useIsHydrated() {
  const [isHydrated, setIsHydrated] = React6.useState(_isHydrated);
  React6.useEffect(() => {
    if (!_isHydrated) {
      _isHydrated = true;
      setIsHydrated(true);
...
var RovingFocusGroup = React7.forwardRef(
  ...
  __name(function RovingFocusGroup2(props, forwardedRef) {
...
var RovingFocusGroupImpl = React7.forwardRef(__name(function RovingFocusGroupImpl2(props, forwardedRef) {
  const {
...
var RovingFocusGroupItem = React7.forwardRef(
  // blank line to reduce diff noise
  __name(function RovingFocusGroupItem2(props, forwardedRef) {
    const {
      __scopeRovingFocusGroup,
      focusable = true,
      active = false,
